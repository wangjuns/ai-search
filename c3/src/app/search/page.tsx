...
export default function SearchPage() {
  ...
  const append = async (newResult: SearchResult) => {
  ...
  return (
    <div className="absolute inset-0 bg-[url('/ui/bg.svg')]">
      <div className="mx-auto max-w-3xl absolute inset-4 md:inset-8 bg-white">
        ...
        <div className="px-4 md:px-8 pt-6 pb-24 rounded-2xl ring-8 ring-zinc-300/20 border border-zinc-200">
        ...
        <div className="fixed mx-auto max-w-3xl inset-x-4 md:inset-x-8 flex items-center justify-center bottom-6 px-4 md:px-8 w-full">
